      ...
      <div className="relative">
        ...
        <input
          ...
          className={cn(
            ...
            "focus:ring-1 focus:ring-accent/30 focus:border-accent/50 focus:outline-none focus-visible:border-primary/60 focus-visible:ring-1 focus-visible:ring-primary/50",
            "transition-[color,background-color,border-color,box-shadow,transform,opacity] shadow-inner disabled:opacity-50 disabled:cursor-not-allowed",
            // iOS zoom fix
