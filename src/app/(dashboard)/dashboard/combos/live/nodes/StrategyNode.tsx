...
export function StrategyNode({ data }: NodeProps) {
  ...
  return (
    <div
      className="flex flex-col items-center gap-1 px-3 py-2 rounded-full border-2 bg-bg transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300"
      style={{
        borderColor: color,
