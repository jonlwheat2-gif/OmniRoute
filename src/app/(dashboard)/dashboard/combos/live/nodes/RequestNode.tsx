...
export function RequestNode({ data }: NodeProps) {
  ...
  return (
    <div
      className="rounded-xl border-2 bg-bg px-4 py-3 min-w-[110px] text-center transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-200"
      style={{
        borderColor: color,
